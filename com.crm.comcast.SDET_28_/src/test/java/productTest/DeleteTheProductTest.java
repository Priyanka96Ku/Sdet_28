...
public class DeleteTheProductTest extends BaseClass{
	...
	public void Deletetheproduct() throws Throwable
	{
		...
		String exceptedProductName=eUtility.getStringCellDate(IPathConstants.SHEET_NAME, 6, 3);
